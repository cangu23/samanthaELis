-- Script de migracion: crea todas las tablas de Cerebrito en MySQL
-- Ejecutar en la base de datos MySQL destino
...
CREATE TABLE IF NOT EXISTS retos (
  ...
  nombre            VARCHAR(255) NOT NULL,
  descripcion       TEXT,
  tipo_juego        ENUM('quiz','code_challenge','security_puzzle','drag_drop','speed_race') NOT NULL DEFAULT 'quiz',
  id_modulo         INT NOT NULL,
  id_nivel          INT NOT NULL,
