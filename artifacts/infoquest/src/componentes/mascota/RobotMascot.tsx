...
export function RobotMascot({
  ...
  return (
    <div
      className={cn("relative inline-flex flex-col items-center robot-float", className)}
    >
      <svg
        width={s.body * 1.2}
        height={s.body * 1.5}
      ...
      >
        {/* Antena */}
        <g style={{ transformOrigin: "72px 20px" }} className="robot-antenna">
          <rect x="68" y="2" width="8" height="20" rx="4" fill="#0EA5E9" />
          <circle cx="72" cy="4" r="6" fill="#06B6D4">
            <animate attributeName="r" values="6;8;6" dur="1.5s" repeatCount="indefinite" />
            <animate attributeName="fill" values="#06B6D4;#0EA5E9;#06B6D4" dur="1.5s" repeatCount="indefinite" />
          </circle>
        ...
        <g>
          ...
          <rect x="46" y="50" width="8" height="8" rx="2" fill={eyeColor}>
            <animate attributeName="transform" attributeType="XML" type="scale" values="1 1;1 0.1;1 1" dur="3.2s" repeatCount="indefinite" additive="sum" />
          </rect>
        ...
        <g>
          ...
          <rect x="90" y="50" width="8" height="8" rx="2" fill={eyeColor}>
            <animate attributeName="transform" attributeType="XML" type="scale" values="1 1;1 0.1;1 1" dur="3.2s" begin="0.15s" repeatCount="indefinite" additive="sum" />
          </rect>
        ...
        {mood === "happy" || mood === "excited" ? (
          <path d="M 44 80 Q 72 90 100 80" stroke={eyeColor} strokeWidth="3" strokeLinecap="round" fill="none" />
        ) : mood === "wrong" ? (
          <path d="M 44 88 Q 72 78 100 88" stroke="#EF4444" strokeWidth="3" strokeLinecap="round" fill="none" />
        ) : (
        ...
        {/* Brazo izquierdo */}
        <g style={{ transformOrigin: "18px 130px" }} className={mood === "excited" ? "robot-arm-excited" : "robot-arm-left"}>
        ...
        {/* Brazo derecho */}
        <g style={{ transformOrigin: "126px 130px" }} className="robot-arm-right">
      ...
      {/* Sombra en el suelo */}
      <div
        className="absolute bottom-0 left-1/2 -translate-x-1/2 rounded-full bg-primary/20 blur-md robot-shadow"
